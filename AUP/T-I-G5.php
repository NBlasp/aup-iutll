 ...
 <div class="row">
    <div class="col-sm-8" id="info">
      ...
      <br>
        ...
        <p class="parrafo">Álvarez Dubraska.</p>
        <p class="parrafo">Ortega Evelyn.</p>
        <p class="parrafo">Salazar Ormary.</p>
        <p class="parrafo">Vásquez Juan.</p>

      <nav>
        <ul class="pager">
          <li class="previous"><a href="T-I-G4.php"><span aria-hidden="true">&larr;</span> Proyecto anterior</a></li>
          <li class="next"><a href="Proyectos_iutll.php">Regresar al manú <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
